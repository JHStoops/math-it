...
@Component({
  selector: 'app-lightning-round-practice',
  templateUrl: './lightning-round-practice.component.html',
  styleUrls: ['./lightning-round-practice.component.css']
})
export class LightningRoundPracticeComponent implements OnInit {
    topic = '';
    index = 0;
    correctAnswers = 0;
    problems = {
